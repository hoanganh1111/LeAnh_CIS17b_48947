...
<html>
    ...
    <body>
        ...
        $sql = "SELECT `first_name`, `last_name`, `email`, `password` FROM `DnD_48947`.`admin_entity` AS `admin_entity`";
        
//        include 'connect_to_server_local.php';
//        $sql = "SELECT `first_name`, `last_name`, `email`, `password` FROM `DnD`.`admin_entity` AS `admin_entity`";
