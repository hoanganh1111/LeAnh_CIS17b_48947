...
<html>
    <body>
        ...
        $sql = "SELECT `char_entity`.`char_id`, `class_enum`.`class`, `char_entity`.`x_loc`, `char_entity`.`y_loc`, `char_entity`.`sight` FROM `DnD`.`class_enum` AS `class_enum`, `DnD`.`char_entity` AS `char_entity` WHERE `class_enum`.`class_id` = `char_entity`.`class_id`";
