...
<html>
    ...
    <body>
        ...
        $sql = "SELECT  `user_id` FROM `DnD_48947`.`user_entity` AS `user_entity`";
        // access the database
        ...
        // Define the query:
        $sql = "SELECT  `user_id`, `first_name`, `last_name`, `email`, `username`, `password` FROM `DnD_48947`.`user_entity` AS `user_entity` ORDER BY `".$sort."` LIMIT ".$start.", ".$display."";
        ...
        $strTab.='<td align="left"><b><a href="admin_view.php?sort=username">Username</a></b></td>';
        ...
        if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
                ...
                $strRow.=('<td align="left">'.$row['username'].'</td>');
